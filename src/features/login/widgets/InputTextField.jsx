  ...
  return (
    <div>
      <div className="relative my-4 " >
                ...
                <label className=" absolute text-xl text-violet-800 transform scale-75 top-3 -z-10 origin-[0] peer-focus:text-blue-600 peer-focus:dark:text-white peer-placeholder-shown:scale-100 peer-focus:scale-75 -translate-y-8 duration-500" htmlFor=''>Your Email</label>
            </div>
            <div  className="relative my-4">
                ...
                <label className="absolute text-xl text-violet-800 transform scale-75 top-3 -z-10 origin-[0] peer-focus:text-blue-600 peer-focus:dark:text-white peer-placeholder-shown:scale-100 peer-focus:scale-75 -translate-y-8 duration-500" htmlFor=''>Your Password</label>
